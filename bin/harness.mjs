...
// ================================================================
// metrics — 本地匿名指标（HTH-019）
// ================================================================
else if (cmd === 'metrics') {
  await import('./metrics.mjs').then(m => m.runMetrics({ rootDir: ROOT, config, args: args.slice(1) }));
}
...
// ================================================================
  ...
  await import('./hooks.mjs').then(m => m.runHooks({ rootDir: ROOT, args }));
}
